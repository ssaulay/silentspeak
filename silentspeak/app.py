...
if video_file is not None:
    path_avi = save_uploadedfile(video_file)

    clip = VideoFileClip(path_avi)
    clip = clip.write_videofile(path_avi[:-4]+'.mp4')

    path_mp4 = os.path.join(path_avi[:-4]+'.mp4')

    # Display the video
    video_clip = st.video(path_mp4)
